...
function App() {
  ...
  if (isLoading) {
    return (
      <div className="text-red-600 text-2xl flex justify-center my-60 animate-spin">
        <Loader2 />
      </div>
    );
  }
    ...
    <>
      ...
      >
        ...
        >
          ...
          <p className="text-2xl pl-2 text-gray-400">
            Treat yourself with sneakers & fashion from{" "}
            <span className="text-white">Jaha</span>
          </p>
