...
function CustomProductHook({ product,tableName }) {
    ...
    return (
        <div className='flex flex-col items-center gap-4'>
            ...
            <button onClick={addToCart} className='border rounded-full w-full p-1 hover:scale-105 bg-black hover:bg-slate-700 text-white transition-all duration-400 active:scale-95'>Add to Cart</button>
